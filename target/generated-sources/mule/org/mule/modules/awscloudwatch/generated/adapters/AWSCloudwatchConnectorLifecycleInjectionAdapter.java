...
/**
 * A <code>AWSCloudwatchConnectorLifecycleInjectionAdapter</code> is a wrapper around {@link AWSCloudwatchConnector } that adds lifecycle methods to the pojo. This adapter also allows the injection of several Mule facilities when a MuleContext is set.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2019-05-30T02:27:08+08:00", comments = "Build UNNAMED.2793.f49b6c7")
public class AWSCloudwatchConnectorLifecycleInjectionAdapter
    extends AWSCloudwatchConnectorMetadataAdapter
    implements MuleContextAware, Disposable, Initialisable, Startable, Stoppable
{
    ...
    {
        Logger log = LoggerFactory.getLogger(AWSCloudwatchConnectorLifecycleInjectionAdapter.class);
