...
/**
 * A <code>AWSCloudwatchConnectorMetadataAdapter</code> is a wrapper around {@link AWSCloudwatchConnector } that adds support for querying metadata about the extension.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2019-05-30T02:27:08+08:00", comments = "Build UNNAMED.2793.f49b6c7")
public class AWSCloudwatchConnectorMetadataAdapter
    extends AWSCloudwatchConnectorCapabilitiesAdapter
    implements MetadataAware
{

    private final static String MODULE_NAME = "AWS Cloudwatch";
